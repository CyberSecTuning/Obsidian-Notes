...
```shell-session
xeloki@htb[/htb]$ sudo apt install rsync -y
```
...
```shell-session
xeloki@htb[/htb]$ rsync -av /path/to/mydirectory user@backup_server:/path/to/backup/directory
```
...
```shell-session
xeloki@htb[/htb]$ rsync -avz --backup --backup-dir=/path/to/backup/folder --delete /path/to/mydirectory user@backup_server:/path/to/backup/directory
```
...
```shell-session
xeloki@htb[/htb]$ rsync -av user@remote_host:/path/to/backup/directory /path/to/mydirectory
```
...
```shell-session
xeloki@htb[/htb]$ rsync -avz -e ssh /path/to/mydirectory user@backup_server:/path/to/backup/directory
```
...
```shell-session
xeloki@htb[/htb]$ chmod +x RSYNC_Backup.sh
```
